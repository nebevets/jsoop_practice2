...
class Modal{
	...
	show(){
		this.modalShadow.css('display', 'unset');
		this.modalBody.css('display', 'unset');
	}
	//takes in no arguments
	//returns nothing
	//hides the given modal shadow and the given modal body
	hide(){
		this.modalShadow.css('display', 'none');
	...
	init(){
		this.hide();
		this.modalShadow.click(this.onClose.bind(this));
		this.modalShadow.click(this.hide.bind(this));
	}
